...
void checarColisiones() {
	if (//orilla derecha del triangulo es mayor que la orilla derecha del cuadrado
		posXTriangulo + 0.15f >= posXCuadrado - 0.15f &&
		//orilla izquierda del triangulo es menos que la orilla derecha del cuadrado
		posXTriangulo - 0.15f <= posXCuadrado + 0.15f &&
		//orilla seuperior del triangulo s mayor que la orilla inferior del cuadrado
		posYTriangulo + 0.15f >= posYCuadrado - 0.15f &&
		//orilla inferior del trangulo mayor que orilla superior que cuadrado
		posYTriangulo - 0.15f <= posYCuadrado + 0.15f) {
		rojoTriangulo = 0.0f;
		verdeTriangulo = 0.0f;
		azulTriangulo = 0.0f;
